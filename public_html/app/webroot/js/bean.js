...
function compreLaqQuesBean(quesId,langData,groupComprehensionLaqQuestions,jwAudioVideo,allowedProgression,noOfReplays,isControlEnable,autoplay){
	this.quesId = quesId;
