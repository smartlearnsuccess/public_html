...
$(document).ready(function(){
    ...
    allSelectedText: getLocale('All Selected'),filterPlaceholder: getLocale('Search'),nonSelectedText: getLocale('None selected'),selectAllText: getLocale('Select All'),enableFiltering: true,enableCaseInsensitiveFiltering: true,maxHeight: 200,buttonWidth: '220px'});
