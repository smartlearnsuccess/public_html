...
class Weblogo extends AppModel
{
	...
	public $validate = array(
		...
		'favicon' => array(
			'isValidExtension' => array('rule' => array('isValidExtension', array('jpg', 'jpeg', 'png'), false), 'allowEmpty' => false, 'message' => 'File does not have a valid extension'),
			'isValidMimeType' => array('rule' => array('isValidMimeType', array('image/jpeg', 'image/png',), false), 'message' => 'You must supply a JPG or PNG File.'),
			'isBelowMaxHeight' => array('rule' => array('isBelowMaxHeight', 256), 'message' => 'You must supply image height is less than 256px'),
		)
	);
}
