    ...
    <div class="col-md-12">
        <div class="panel panel-default mrg">
            <div class="panel-heading">
                <div class="widget-modal"><h4
                            class="widget-modal-title"><?php echo __('Add Testimonials'); ?></strong></h4></div>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label">
                        <small><?php echo __('Rating'); ?></small>
                    </label>
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('rating', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Rating'), 'div' => false)); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label">
                        <small><?php echo __('Upload Photo (150*150)'); ?></small>
                    </label>
                    <div class="col-sm-9">
