<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit'); ?> <?php echo __('Menu Names'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Menuname as $k => $post): $id = $post['Menuname']['id'];
                $form_no = $k + 1; ?>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-3 control-label"><?php echo __('Model Name'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-3 control-label"><?php echo __('Page Name'); ?></label>
                            <div class="col-sm-9">
