                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->Function->secondsToWords($examDetails['ExamResult']['test_time']); ?></td>
                        </tr>
                        <tr>
                            <td><strong class="text-danger"><?php echo __('Total Time'); ?></strong></td>
                            <td><?php echo $this->Function->secondsToWords($examDetails['ExamResult']['total_test_time'] * 60); ?></td>
                        </tr>
                        <tr>
                            <td>
