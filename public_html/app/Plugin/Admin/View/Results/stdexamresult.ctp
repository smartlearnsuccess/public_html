        ...
        <td width="70%">
            <div class="panel panel-default">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><strong class="text-danger"><?php echo __('Nos. of Browser tolerance attempt'); ?></strong>
                        </td>
                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        <?php foreach ($userMarksheet as $userValue): ?>
                            <tr>
                                <td class="text-danger"><strong><?php echo h($userValue['Subject']['name']); ?></strong>
                                </td>
        ...
        <td width="30%">
            <div class="panel panel-default">
                ...
                <table class="table">
                    <tr>
                        <td>
                            <div style="margin:5px;height:15px;width:15px; border:8px solid #0d233a;">&nbsp;</div>
                        </td>
                        <td><strong><?php echo __('Maximum Score'); ?></strong></td>
                    </tr>
                    <tr>
                        <td>
                            <div style="margin:5px;height:15px;width:15px;border:8px solid #39ae39;">&nbsp;</div>
                        </td>
                        <td><strong><?php echo __('Developed Skill'); ?></strong></td>
                    </tr>
                    <tr>
                        <td>
                            <div style="margin:5px;height:15px;width:15px;border:8px solid #f79327;">&nbsp;</div>
                        </td>
                        <td><strong><?php echo __('Needs Development'); ?></strong></td>
                    </tr>
                    <tr>
                        <td>
                            <div style="margin:5px;height:15px;width:15px;border:8px solid #eb1d1d;">&nbsp;</div>
                        </td>
