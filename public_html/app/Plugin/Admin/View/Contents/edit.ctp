<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Pages'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel">
            <div class="panel-body"><?php echo $this->Session->flash(); ?>
                ...
                <?php foreach ($Content as $k => $post): $id = $post['Content']['id'];
                    $form_no = $k + 1; ?>
                        ...
                        <div class="panel-body"><?php echo $this->Session->flash(); ?>
                            ...
                            <div class="form-group">
                                <label for="group_name"
                                       class="col-sm-2 control-label"><?php echo __('Link Name'); ?></label>
                                <div class="col-sm-4">
