...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('SEO'); ?></h1></div>
    </div>
    <div class="panel"><?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Seos'));
                echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;' . __('Add New SEO'), array('controller' => 'Seos', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-success')); ?>
