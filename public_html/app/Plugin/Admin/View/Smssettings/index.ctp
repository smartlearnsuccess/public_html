<div class="panel panel-custom">
    ...
    <div class="panel-body">
		...
		<div class="form-group">
            <label for="site_name" class="col-sm-2 control-label"><?php echo __('DLT Template Heading'); ?></label>
            <div class="col-sm-4">
                <?php echo $this->Form->input('dlt_template_name', array('label' => false, 'class' => 'form-control', 'placeholder' => __('DLT Template Id field provided by sms gateway'), 'div' => false)); ?>
            </div>
        </div>
        <div class="form-group">
            <label for="site_name" class="col-sm-2 control-label"><?php echo __('Post Type'); ?></label>
            <div class="col-sm-4">
                <?php echo $this->Form->input('post_type', array('type' => 'radio', 'options' => array('GET' => __('GET'), 'POST' => __('POST')),'default'=>'GET', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'label' => false, 'div' => false)); ?>
            </div>
            <label for="site_name"
