    ...
    <div class="panel">
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $this->Form->input('exam_mode', array('type' => 'radio', 'options' => array("D" => __('Default'), "T" => __('Section Wise Timer')), 'default' => 'D', 'legend' => false, 'before' => '<label class="radio-inline">', 'separator' => '</label><label class="radio-inline">', 'after' => '</label>', 'label' => false, 'div' => false)); ?>
                </div>
            </div>
