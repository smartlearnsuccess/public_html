                            ...
                            <td class="pbutton">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
										<?php if ($post['Exam']['exam_mode'] == "T"){?><li><?php echo $this->Html->link('<span class="fa fa-clock-o"></span>&nbsp;' . __('Set Section Wise Time'), 'javascript:void(0);', array('onclick' => "show_modal('$url/sectiontime/$id');", 'escape' => false)); ?></li><?php }?>
