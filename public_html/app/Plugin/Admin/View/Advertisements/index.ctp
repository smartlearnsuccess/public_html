...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Advertisements'); ?></h1></div>
    </div>
    <div class="panel">
        <?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Advertisements'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Advertisement'), array('controller' => 'Advertisements', 'action' => 'add'), array('escape' => false, 'class' => 'btn btn-success')); ?>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($Advertisement as $post):
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="label label-<?php if ($post['Advertisement']['status'] == "Active") echo "success"; else echo "danger"; ?>"><?php echo __($post['Advertisement']['status']); ?></span>
                            </td>
                            <td>
                                <div class="btn-group">
