...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Groups'); ?></h1></div>
    </div>
    <div class="panel">
        ...
        <div class="panel-heading">
            <div class="btn-group">
                ...
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Group'), array('controller' => 'Groups', 'action' => 'add'), array('escape' => false, 'escape' => false, 'class' => 'btn btn-success')); ?>
