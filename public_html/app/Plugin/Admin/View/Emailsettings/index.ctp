<script type="text/javascript">
    $(document).ready(function () {
        <?php if($this->request->data['Emailsetting']['type'] == "Smtp"){?>$('#smtp').show();
        <?php }else{?>$('#smtp').hide();<?php }?>
...
<div class="panel panel-custom">
    ...
    <div class="panel-body">
        <?php echo $this->Form->create('Emailsetting', array('url' => array('action' => 'index'), 'type' => 'post', 'class' => 'form-horizontal')); ?>
        ...
        <div id="smtp">
            ...
            <div class="form-group">
                <label for="site_name" class="col-sm-2 control-label"><?php echo __('STARTTLS'); ?></label>
                <div class="col-sm-1">
                    <?php echo $this->Form->checkbox('tls', array('label' => false, 'class' => '', 'div' => false)); ?>
                </div>
            </div>
        </div>
