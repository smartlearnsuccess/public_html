<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Transaction History'); ?></h1></div>
</div>
<div class="panel">
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($Transactionhistory as $post): ?>
                    <tr>
                        ...
                        <td><?php if ($post['Wallet']['in_amount']) {
                                echo $currency . $post['Wallet']['in_amount'];
                            } ?></td>
                        <td><?php if ($post['Wallet']['out_amount']) {
                                echo $currency . $post['Wallet']['out_amount'];
                            } ?></td>
                        <td><?php if ($post['Wallet']['balance']) {
                                echo $currency . $post['Wallet']['balance'];
                            } ?></td>
