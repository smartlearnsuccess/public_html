...
<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    ...
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Update Photo'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"> <?php echo $this->Session->flash(); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php echo $this->Form->input('photo', array('type' => 'file', 'label' => false, 'required' => true, 'class' => 'form-control filestyle', 'div' => false, 'data-text' => __("Choose Photo"), 'data-btnClass' => "btn-primary")); ?>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-9">
