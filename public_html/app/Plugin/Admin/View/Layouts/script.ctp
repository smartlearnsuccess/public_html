...
<head>
	...
	if ($mathEditor && (strtolower($this->params['controller']) == "questions" ||  strtolower($this->params['controller']) == "results" ||  strtolower($this->params['controller']) == "attemptedpapers")) {
		echo $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=AM_HTMLorMML-full');
	}
