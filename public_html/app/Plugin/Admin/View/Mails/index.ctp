...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Mailbox'); ?></h1></div>
    </div>
                    ...
                    <div class="sidebar-row">
                        <ul class="list-unstyled mailbox-list">
                            <li <?php if ($urlAction == "index") {
                                echo "class=\"active\"";
                            } ?>><?php echo $this->Html->link(__('Inbox') . "<span class=\"badge badge-success pull-right\">$totalInbox</span>&nbsp;", array('controller' => 'Mails', 'action' => 'index'), array('escape' => false)); ?></li>
                            <li <?php if ($urlAction == "sent") {
                                echo "class=\"active\"";
                            } ?>><?php echo $this->Html->link(__('Sent Mail'), array('controller' => 'Mails', 'action' => 'sent'), array('class' => 'btn-group dropup btn-block')); ?></li>
                            <li <?php if ($urlAction == "trash") {
                                echo "class=\"active\"";
                            } ?>><?php echo $this->Html->link(__('Trash'), array('controller' => 'Mails', 'action' => 'trash'), array('class' => 'btn-group dropup btn-block')); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="list-group mail-action list-unstyled list-inline">
                                    ...
                                    <?php if ($urlAction != "sent") { ?>
                                        <li class="dropdown"><a href="#" data-toggle="dropdown"
                                                    ...
                                                    class="fa fa-folder"></i>&nbsp; <?php echo __('More'); ?>
                                            &nbsp;<span
                                                    class="caret"></span></a>
                                        <ul role="menu" class="dropdown-menu">
                                            ...
                                            <?php if ($urlAction == "trash") { ?>
                                                <li><?php echo $this->Html->link(__('Move to Inbox'), 'javascript:void(0);', array('onclick' => 'check_perform_more("inbox");')); ?></li><?php } ?>
                                        </ul>
                                        </li><?php } ?>
                                </ul>
