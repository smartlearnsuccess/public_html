                ...
                <?php foreach ($Smstemplate as $k => $post): $id = $post['Smstemplate']['id'];
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="form-group">
								<label for="group_name" class="col-sm-4 control-label">
									<small><?php echo __('DLT Template Id'); ?>:</small>
								</label>
								<div class="col-sm-6">
									<?php echo $this->Form->input("$k.Smstemplate.dlt_template_value", array('label' => false, 'class' => 'form-control', 'placeholder' => __('DLT Template Id'), 'div' => false)); ?>
								</div>
							</div>
                            <div class="form-group">
                                <label for="group_name" class="col-sm-4 control-label">
