<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Email Templates'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body">
            ...
            <?php foreach ($Emailtemplate as $k => $post): $id = $post['Emailtemplate']['id'];
                $form_no = $k + 1; ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="group_name" class="col-sm-2 control-label">
                                <small><?php echo __('Email Template'); ?>:</small>
                            </label>
                            <div class="col-sm-10">
