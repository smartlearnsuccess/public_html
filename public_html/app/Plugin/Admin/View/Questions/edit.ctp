                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            echo $this->Form->select('topic_id', $topic, array('rel' => $urlTopic, 'class' => 'form-control', 'required' => true, 'empty' => __('Please Select'))); ?>
                        </div>
                        <label for="group_name" class="col-sm-1 control-label"><?php echo __('Sub Topic'); ?></label>
                        <div class="col-sm-5">
                            <?php echo $this->Form->select('stopic_id', $stopic, array('class' => 'form-control', 'required' => true, 'empty' => __('Please Select'))); ?>
                        </div>
                    </div>
                </div>
            </div>
