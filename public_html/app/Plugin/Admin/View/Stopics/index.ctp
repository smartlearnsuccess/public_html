...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Sub Topics'); ?></h1></div>
    </div>
    <div class="panel">
        <?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Stopics'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Sub Topic'), array('controller' => 'Stopics', 'action' => 'add'), array('escape' => false, 'escape' => false, 'class' => 'btn btn-success')); ?>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('Topic.name', __('Topic Name'), array('direction' => 'asc')); ?></th>
                        <th><?php echo $this->Paginator->sort('name', __('Sub Topic Name'), array('direction' => 'asc')); ?></th>
                        <th><?php echo __('Action'); ?></th>
                    </tr>
                    <?php foreach ($Stopic as $post):
                        $id = $post['Stopic']['id']; ?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false, array('value' => $post['Stopic']['id'], 'name' => 'data[Stopic][id][]', 'id' => "DeleteCheckbox$id", 'class' => 'chkselect')); ?></td>
