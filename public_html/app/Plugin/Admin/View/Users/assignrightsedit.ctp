...
<div class="container">
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Assign Form Rights'); ?>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        </div>
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            <?php echo $this->Form->create('User', array('url' => array('controller' => 'Users', 'action' => "assignrightsedit", $id), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($PageRight as $k => $post): $prId = $post['Page']['id'];
                        $pageId = $post['PageRight']['page_id'];
                        $ugroupId = $post['PageRight']['ugroup_id'];
