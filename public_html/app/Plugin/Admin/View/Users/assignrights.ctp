<div class="page-title">
    <div class="title-env"><h1 class="title"><?php echo __('Level users'); ?></h1></div>
</div>
<div class="panel">
    ...
    <div class="panel-heading">
        <div class="btn-group">
            ...
            $url1 = str_replace("/assignrights", "", $this->Html->url(array('controller' => 'Users')));
            echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Level'), array('controller' => 'Users', 'action' => 'leveladd'), array('escape' => false, 'class' => 'btn btn-success')); ?>
    ...
    <?php echo $this->Form->create(array('name' => 'deleteallfrm', 'url' => array('action' => 'deletelevel'))); ?>
