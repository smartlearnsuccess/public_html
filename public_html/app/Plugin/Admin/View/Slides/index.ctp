...
<div id="resultDiv">
    ...
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Slides') ?></h1></div>
    </div>
    <div class="panel"><?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Slides'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Slide'), 'javascript:void(0);', array('name' => 'add', 'id' => 'add', 'onclick' => "check_perform_add('$url/add');", 'escape' => false, 'class' => 'btn btn-success')); ?>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php foreach ($Slide as $post):
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="label label-<?php if ($post['Slide']['status'] == "Active") echo "success"; else echo "danger"; ?>"><?php echo __($post['Slide']['status']); ?></span>
                            </td>
                            <td>
                                <div class="btn-group">
