<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Slides'); ?> <?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Slide as $k => $post): $id = $post['Slide']['id'];
                $form_no = $k + 1; ?>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-3 control-label"><?php echo __('Slide Name'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <?php echo $this->Form->input("$k.Slide.heading", array('label' => false, 'class' => 'form-control', 'placeholder' => __('Heading'), 'div' => false)); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="group_name" class="col-sm-3 control-label">
                            ...
                            <div class="col-sm-9">
                                <?php echo $this->Tinymce->input("$k.Slide.content", array('id' => $id, 'label' => false, 'class' => 'form-control', 'placeholder' => __('Content'), 'div' => false), array('language' => $configLanguage, 'directionality' => $dirType), 'full'); ?>
                            </div>
                        </div>
                        <div class="form-group">
