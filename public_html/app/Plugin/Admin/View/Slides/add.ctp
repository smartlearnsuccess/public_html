<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Add Slides'); ?><?php if (!$isError) { ?>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php } ?>
        </div>
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            <?php echo $this->Form->create('Slide', array('name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal', 'type' => 'file')); ?>
            <div class="form-group">
                <label for="group_name" class="col-sm-3 control-label">
                    <small><?php echo __('Slide Name'); ?></small>
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php echo $this->Form->input('heading', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Heading'), 'div' => false)); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="group_name" class="col-sm-3 control-label">
                ...
                <div class="col-sm-9">
                    <?php echo $this->Tinymce->input('content', array('class' => 'form-control', 'placeholder' => __('Content'), 'label' => false), array('language' => $configLanguage, 'directionality' => $dirType), 'full'); ?>
                </div>
            </div>

            <div class="form-group">
                <label for="group_name" class="col-sm-3 control-label">
                    <small><?php echo __('Ordering'); ?></small>
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label for="group_name" class="col-sm-3 control-label">
                    <small><?php echo __('Upload Slide (1350*550)'); ?></small>
                </label>
                <div class="col-sm-9">
