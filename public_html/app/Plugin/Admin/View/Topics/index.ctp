...
<div id="resultDiv">
    <div class="page-title">
        <div class="title-env"><h1 class="title"><?php echo __('Topics'); ?></h1></div>
    </div>
    <div class="panel">
        <?php echo $this->Session->flash(); ?>
        <div class="panel-heading">
            <div class="btn-group">
                <?php $url = $this->Html->url(array('controller' => 'Topics'));
                echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;' . __('Add New Topic'), array('controller' => 'Topics', 'action' => 'add'), array('escape' => false, 'escape' => false, 'class' => 'btn btn-success')); ?>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('subject_name', __('Subject'), array('direction' => 'asc')); ?></th>
                        <th><?php echo $this->Paginator->sort('name', __('Topic Name'), array('direction' => 'asc')); ?></th>
                        <th><?php echo __('Action'); ?></th>
                    </tr>
                    <?php foreach ($Topic as $post):
                        $id = $post['Topic']['id']; ?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false, array('value' => $post['Topic']['id'], 'name' => 'data[Topic][id][]', 'id' => "DeleteCheckbox$id", 'class' => 'chkselect')); ?></td>
