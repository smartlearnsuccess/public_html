<div <?php if (!$isError){ ?>class="container"<?php } ?>>
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit Topics'); ?><?php if (!$isError) { ?>
        ...
        <div class="panel-body"><?php echo $this->Session->flash(); ?>
            ...
            <?php foreach ($Topic as $k => $post): $id = $post['Topic']['id'];
                $form_no = $k + 1; ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <?php echo $this->Form->select("$k.Topic.subject_id", $subject, array('required' => true, 'label' => false, 'class' => 'form-control', 'empty' => __('Please Select'), 'div' => false)); ?>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="group_name"
                                   class="col-sm-3 control-label"><?php echo __('Topic Name'); ?></label>
                            <div class="col-sm-9">
                                <?php echo $this->Form->input("$k.Topic.name", array('label' => false, 'class' => 'form-control', 'placeholder' => __('Topic Name'), 'div' => false)); ?>
                            </div>
                        </div>
                        <div class="form-group text-left">
                            <div class="col-sm-offset-3 col-sm-6">
                                <?php echo $this->Form->input("$k.Topic.id", array('type' => 'hidden')); ?>
                            </div>
                        </div>
                    </div>
                </div>
