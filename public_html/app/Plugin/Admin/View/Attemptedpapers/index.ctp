											...
											<a data-toggle="collapse"
											   href="#collapse<?php echo $ques['ExamStat']['ques_no']; ?>">
												...
												<span class="text-success">
													<?php }elseif ($ques['ExamStat']['ques_status'] == "W"){ ?>
													...
													<?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "M") { ?>
														<?php if (strlen($ques['option1']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option1'); ?></strong>
																</td>
														...
														<?php if (strlen($ques['option2']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option2'); ?> </strong>
																</td>
														...
														<?php if (strlen($ques['option3']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option3'); ?></strong>
																</td>
														...
														<?php if (strlen($ques['option4']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option4'); ?></strong>
																</td>
														...
														<?php if (strlen($ques['option5']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option5'); ?></strong>
																</td>
														...
														<?php if (strlen($ques['option6']) > 0) { ?>
															<tr class="text-left">
																<td>
																	<strong
																		class="text-warning"><?php echo __('Option6'); ?></strong>
																</td>
													...
													<tr>
														...
														<td colspan="2">
															<?php if ($Qtype[$ques['qtype_id'] - 1]['Qtype']['type'] == "S") {
																if ($ques['ExamStat']['answered'] == "1") {
																	echo '<span class="text-success">' . __('Attempted') . '</span>';
																} else {
																	echo '<span class="text-danger">' . __('Not Attempted') . '</span>';
																}
															} else { ?>
																<span
																	class="text-success"><?php echo __('Correct Answer'); ?>
																: <?php echo h($correctAnswer); ?></span><?php } ?></td>
													</tr>
													<tr>
														<td><?php echo __('Time Taken'); ?>
															: <?php echo $this->Function->secondsToWords($ques['ExamStat']['time_taken'], "-"); ?></td>
