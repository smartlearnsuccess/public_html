...
class MailsController extends AdminAppController
{
    ...
    public function studentsearch()
    {
        ...
        $users = $this->Student->find('all', array(
            'fields'=>array('Student.id','Student.email'),
            'joins' => array(array('table' => 'student_groups', 'alias' => 'StudentGroup', 'type' => 'INNER', 'conditions' => array('Student.id=StudentGroup.student_id'))),
            'conditions' => array('Student.email LIKE' => '%' . $term . '%', "StudentGroup.group_id"=>$this->userGroupWiseId),
            'group'=>array('Student.id','Student.email'),
        ));
