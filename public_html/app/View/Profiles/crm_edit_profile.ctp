    ...
    <div class="col-md-10">
        ...
        <div class="panel">
            <div class="panel-body">
                <?php echo $this->Form->create('Profile', array('url' => array('controller' => 'Profiles', 'action' => 'editProfile'), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal')); ?>
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label"><?php echo __('Enrolment No'); ?></label>
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('enroll', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Enrolment No'), 'div' => false)); ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label"><?php echo __('Alternate Number'); ?></label>
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('guardian_phone', array('label' => false, 'class' => 'form-control', 'placeholder' => __('Alternate Number'), 'div' => false)); ?>
                    </div>
                </div>
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label"><?php echo __('Address'); ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group text-left">
                    <div class="col-sm-offset-3 col-sm-7">
                        <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span>&nbsp;<?php echo __('Update'); ?>
                        </button>
                    </div>
                </div>
