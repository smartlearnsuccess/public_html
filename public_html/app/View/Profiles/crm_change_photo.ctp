    ...
    <div class="col-md-10">
        ...
        <div class="panel">
            <div class="panel-body">
                <?php echo $this->Form->create('Profile', array('url' => array('controller' => 'Profiles', 'action' => 'changePhoto'), 'name' => 'post_req', 'id' => 'post_req', 'class' => 'form-horizontal', 'type' => 'file')); ?>
                <div class="form-group">
                    <label for="group_name" class="col-sm-3 control-label"><?php echo __('Upload Photo'); ?></label>
                    <div class="col-sm-9">
                        <?php echo $this->Form->input('photo', array('required' => true, 'type' => 'file', 'label' => false, 'class' => 'form-control filestyle', 'div' => false, 'data-text' => __("Choose Photo"), 'data-btnClass' => "btn-primary")); ?>
                    </div>
                </div>
                <div class="form-group text-left">
                    <div class="col-sm-offset-3 col-sm-7">
                        <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span>&nbsp;<?php echo __('Submit'); ?>
                        </button>
                    </div>
                </div>
