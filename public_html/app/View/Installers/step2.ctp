        ...
        <div class="col-md-12 mrg">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<div class="form-group">
                        <label for="inputPassword3"
                               class="col-sm-2 control-label"><?php echo __('Database Port'); ?></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <?php echo $this->Form->input('dbport', array('value'=>'3306','class' => 'form-control', 'label' => false, 'placeholder' => __('Database Port'))); ?>
