        ...
        <div class="col-md-12 mrg">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<div class="form-group">
						<label for="inputPassword3"
							   class="col-sm-2 control-label"><?php echo __('Purchase Code'); ?></label>
						<div class="col-sm-10">
							<?php echo $this->Form->input('ins_code', array('required' => true, 'class' => 'form-control', 'label' => false, 'placeholder' => __('Purchase Code'))); ?>
						</div>
					</div>
