...
<div class="tab-pane" id="compare-report">
    ...
    <div class="com-md-12 col-sm-12 col-xs-12">
        <div class="col-md-3 col-sm-6 col-xs-6">
            <table class="table">
                <tr>
                    <td><?php echo __('Total Ques.'); ?>
                        &nbsp;<strong><?php echo $examDetails['Result']['total_question']; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Maximum Marks'); ?>
                        &nbsp;<strong><?php echo $examDetails['Result']['total_marks']; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Attempted Ques.'); ?>&nbsp;<strong
                                class="text-success"><?php echo $attemptedQuestion; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Unattempted Ques.'); ?>&nbsp;<strong
                                class="text-danger"><?php echo $leftQuestion; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Correct Ques.'); ?>&nbsp;<strong
                                class="text-success"><?php echo $correctQuestion; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Incorrect Ques.'); ?>&nbsp;<strong
                                class="text-danger"><?php echo $incorrectQuestion; ?></strong></td>
                </tr>
            </table>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            <table class="table">
                <tr>
                    <td><?php echo __('Total Score'); ?>&nbsp;<strong
                                class="text-primary"><?php echo $examDetails['Result']['obtained_marks']; ?>
                            /<?php echo $examDetails['Result']['total_marks']; ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Percentage'); ?>
                        &nbsp;<strong><?php echo $this->Number->toPercentage($examDetails['Result']['percent']); ?></strong>
                    </td>
                </tr>
                <tr>
                    <td><?php echo __('Percentile'); ?>
                        &nbsp;<strong><?php echo CakeNumber::toPercentage($percentile); ?></strong></td>
                </tr>
                <tr>
                    <td><?php echo __('Total Time'); ?>
                ...
                <tr>
                    <td><?php echo __('Rank'); ?>
                        &nbsp;<?php echo $this->Html->image($studentImage, array('width' => 60, 'height' => 70, 'class' => 'img-thumbnail')); ?></td>
                </tr>
                <tr>
                    <td>
            ...
            <div id="comppanel<?php echo $k; ?>" class="compare">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <table class="table">
                        <tr>
                            <td><?php echo __('Total Ques.'); ?>
                                &nbsp;<strong><?php echo $compPost[0]['Result']['total_question']; ?></strong></td>
                        </tr>
                        <tr>
                            <td><?php echo __('Maximum Marks'); ?>
                                &nbsp;<strong><?php echo $compPost[0]['Result']['total_marks']; ?></strong></td>
                        </tr>
                        <tr>
                            <td><?php echo __('Attempted Ques.'); ?>&nbsp;<strong
                                        class="text-success"><?php echo $compPost['attempted_question']; ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo __('Unattempted Ques.'); ?>&nbsp;<strong
                                        class="text-danger"><?php echo $compPost['left_question']; ?></strong></td>
                        </tr>
                        <tr>
                            <td><?php echo __('Correct Ques.'); ?>&nbsp;<strong
                                        class="text-success"><?php echo $compPost['correct_question']; ?></strong></td>
                        </tr>
                        <tr>
                            <td><?php echo __('Incorrect Ques.'); ?>&nbsp;<strong
                                        class="text-danger"><?php echo $compPost['incorrect_question']; ?></strong></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <table class="table">
                        <tr>
                            <td><?php echo __('Total Score'); ?>&nbsp;<strong
                                        class="text-primary"><?php echo $compPost[0]['Result']['obtained_marks']; ?>
                        ...
                        <tr>
                            <td><?php echo __('Rank'); ?>
                                &nbsp;<?php echo $this->Html->image($compPost['student_image'], array('width' => 60, 'height' => 70, 'class' => 'img-thumbnail')); ?></td>
                        </tr>
                        <tr>
                            <td>
